...
//edited 2019 by Daniel Chan
//outputs at nodes 6, 8, and 11 did not produce anything, adjusted code to allow for there to be an output
...
public class XORGate : MonoBehaviour, LogicInterface
{
    ...
    private void ChipIO()
    {
        ...
        if (logic_dictionary.TryGetValue(LOGIC_DEVICE_ID + 5, out logic_5))
        {
            ...
            LogicNode collided_behavior = collided_node.GetComponent<LogicNode>();
            int collided_state = collided_behavior.GetLogicState();
            LogicNode lnode_3, lnode_4; //LogicNode references
            lnode_3 = logic_3.GetComponent<LogicNode>(); lnode_4 = logic_4.GetComponent<LogicNode>();
            int low = (int)LOGIC.LOW;
            int invalid = (int)LOGIC.INVALID;
            if (IsDeviceOn())
            {
                if (lnode_3.GetCollidingNode().GetComponent<LogicNode>().GetLogicState() == (int)LOGIC.HIGH
                    && lnode_4.GetCollidingNode().GetComponent<LogicNode>().GetLogicState() == (int)LOGIC.HIGH)
                {
                    logic_behavior.SetLogicState((int)LOGIC.LOW);
                }
                else if (lnode_3.GetCollidingNode().GetComponent<LogicNode>().GetLogicState() == (int)LOGIC.HIGH
                    && lnode_4.GetCollidingNode().GetComponent<LogicNode>().GetLogicState() == (int)LOGIC.LOW)
                {
                    logic_behavior.SetLogicState((int)LOGIC.HIGH);
                }
                else if (lnode_3.GetCollidingNode().GetComponent<LogicNode>().GetLogicState() == (int)LOGIC.LOW
                    && lnode_4.GetCollidingNode().GetComponent<LogicNode>().GetLogicState() == (int)LOGIC.HIGH)
                {
                    logic_behavior.SetLogicState((int)LOGIC.HIGH);
                }
        ...
        if (logic_dictionary.TryGetValue(LOGIC_DEVICE_ID + 7, out logic_7))
        {
            ...
            LogicNode collided_behavior = collided_node.GetComponent<LogicNode>();
            int collided_state = collided_behavior.GetLogicState();
            LogicNode lnode_8, lnode_9; //LogicNode references
            lnode_8 = logic_8.GetComponent<LogicNode>(); lnode_9 = logic_9.GetComponent<LogicNode>();
            int low = (int)LOGIC.LOW;
            int invalid = (int)LOGIC.INVALID;
            if (IsDeviceOn())
            {
                if (lnode_8.GetCollidingNode().GetComponent<LogicNode>().GetLogicState() == (int)LOGIC.HIGH
                    && lnode_9.GetCollidingNode().GetComponent<LogicNode>().GetLogicState() == (int)LOGIC.HIGH)
                {
                    logic_behavior.SetLogicState((int)LOGIC.LOW);
                }
                else if (lnode_8.GetCollidingNode().GetComponent<LogicNode>().GetLogicState() == (int)LOGIC.HIGH
                    && lnode_9.GetCollidingNode().GetComponent<LogicNode>().GetLogicState() == (int)LOGIC.LOW)
                {
                    logic_behavior.SetLogicState((int)LOGIC.HIGH);
                }
                else if (lnode_8.GetCollidingNode().GetComponent<LogicNode>().GetLogicState() == (int)LOGIC.LOW
                    && lnode_9.GetCollidingNode().GetComponent<LogicNode>().GetLogicState() == (int)LOGIC.HIGH)
                {
                    logic_behavior.SetLogicState((int)LOGIC.HIGH);
                }
        ...
        if (logic_dictionary.TryGetValue(LOGIC_DEVICE_ID + 10, out logic_10))
        {
            ...
            LogicNode collided_behavior = collided_node.GetComponent<LogicNode>();
            int collided_state = collided_behavior.GetLogicState();
            LogicNode lnode_11, lnode_12; //LogicNode references
            lnode_11 = logic_11.GetComponent<LogicNode>(); lnode_12 = logic_12.GetComponent<LogicNode>();
            int low = (int)LOGIC.LOW;
            int invalid = (int)LOGIC.INVALID;
            if (IsDeviceOn())
            {
                if (lnode_11.GetCollidingNode().GetComponent<LogicNode>().GetLogicState() == (int)LOGIC.HIGH
                    && lnode_12.GetCollidingNode().GetComponent<LogicNode>().GetLogicState() == (int)LOGIC.HIGH)
                {
                    logic_behavior.SetLogicState((int)LOGIC.LOW);
                }
                else if (lnode_11.GetCollidingNode().GetComponent<LogicNode>().GetLogicState() == (int)LOGIC.HIGH
                    && lnode_12.GetCollidingNode().GetComponent<LogicNode>().GetLogicState() == (int)LOGIC.LOW)
                {
                    logic_behavior.SetLogicState((int)LOGIC.HIGH);
                }
                else if (lnode_11.GetCollidingNode().GetComponent<LogicNode>().GetLogicState() == (int)LOGIC.LOW
                    && lnode_12.GetCollidingNode().GetComponent<LogicNode>().GetLogicState() == (int)LOGIC.HIGH)
                {
                    logic_behavior.SetLogicState((int)LOGIC.HIGH);
                }
