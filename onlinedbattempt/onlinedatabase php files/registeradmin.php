...
$salt = "\$5\$rounds-6000\$" . "alexandrosbeatakhilles" . $firstname . "\$";

$hash = crypt($password, $salt);

$sql = "INSERT INTO admin_account(firstname, lastname, email, salt, hash) VALUES('".$firstname."','".$lastname."', '".$email."','".$salt."','".$hash."')";
